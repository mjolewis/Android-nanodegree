...
import com.projectpico.popularmovies.adapters.ReviewAdapter;
import com.projectpico.popularmovies.model.Movie;
import com.squareup.picasso.Picasso;

/**********************************************************************************************************************
 * A detail fragment used to modularize the MovieDetailActivity.java class.
 *
 * @author mlewis
 * @version May 3, 2020
 *********************************************************************************************************************/
public class MovieDetailFragment extends Fragment {
    ...
    private void initializeViews(View rootView) {
        ...
        mTvReleaseDateValue = rootView.findViewById(R.id.tv_movie_release_date);
        mTvDurationValue = rootView.findViewById(R.id.tv_duration);
        mTvVoteValue = rootView.findViewById(R.id.tv_vote_value);
        mTvPlotValue = rootView.findViewById(R.id.tv_plot_value);
        mRatingBar = rootView.findViewById(R.id.ratingBar);
        mGenresContainer = rootView.findViewById(R.id.genres_container);
        mRvVideos = rootView.findViewById(R.id.rv_videos);
        mTvReviewsTitle = rootView.findViewById(R.id.tvReviewsTitle);
        mRvReviews = rootView.findViewById(R.id.rvReviews);
        mFbLike = rootView.findViewById(R.id.fb_Like);
